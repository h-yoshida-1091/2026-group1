...
<head>
    ...
    <style>
        ...
        /* ★ 優先度バッジのスタイル定義 */
        .priority-badge { font-size: 0.8rem; padding: 4px 10px; border-radius: 4px; font-weight: bold; }
                                ...
                                <td>
                                    <div class="mb-2">
                                        @if($contact->priority === 3)
                                            <span class="badge bg-danger priority-badge text-white"><i class="fa-solid fa-triangle-exclamation me-1"></i>優先度：高</span>
                                        @elif($contact->priority === 1)
                                            <span class="badge bg-info priority-badge text-dark"><i class="fa-solid fa-comment-dots me-1"></i>優先度：低</span>
                                        @else
                                            <span class="badge bg-light priority-badge text-secondary border"><i class="fa-solid fa-minus me-1"></i>優先度：中</span>
                                        @endif
                                    </div>
